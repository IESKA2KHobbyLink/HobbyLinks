...
function Header() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const current = localStorage.setItem("currentUser", JSON.stringify(login));
      ...
      <Modal isVisible={showModal2} onClose={() => setShowModal2(false)}>
        <div className='py-6 px-6 lg:px-8 text-left'>
          ...
          <form className='spacy-y-6' onSubmit={handleRegister}>
            ...
            <div>
              <label htmlFor='birthday' className='block mb-2 text-sm font-medium text-grey-900'>
                Birthday
              </label>
            ...
            <div>
              <label htmlFor='gender' className='block mb-2 text-sm font-medium text-grey-900'>
                Gender
              </label>
