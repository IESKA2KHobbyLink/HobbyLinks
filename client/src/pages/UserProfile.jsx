...
function UserProfile() {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const user = await http.get(`http://localhost:8000/api/users/${currentUserId}`);
      ...
      <div>
        <div className='px-44 shadow'>
          <div className='relative h-80 rounded-b flex justify-center'>
            <img
              src={imgPath == "http://localhost:8000null" ? bgPlaceHolder : bgImgPath}
            ...
            <div className='absolute -bottom-6 card flex justify-content-center'>
              <img
                src={imgPath == "http://localhost:8000null" ? placeHolderImg : imgPath}
